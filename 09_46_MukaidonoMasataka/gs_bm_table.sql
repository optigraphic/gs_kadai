...
--
-- Host: localhost
-- Generation Time: 2018 年 10 月 18 日 16:33
-- サーバのバージョン： 5.6.21
-- PHP Version: 5.6.3
...
(97, '荻窪ルースター物語', '佐藤ヒロオ', 'ポット出版', '2006-09', 'http://books.google.co.jp/books?id=5b27agq0l2QC&dq=isbn:9784939015908&hl=&source=gbs_api', 'ライブハウスはバンドを育てる場所じゃない。生演奏を楽しんでもらう飲食店なんだ。', '9784939015908', '2018-10-18 23:19:31', 'http://books.google.com/books/content?id=5b27agq0l2QC&printsec=frontcover&img=1&zoom=5&source=gbs_api'),
(98, 'ぜんぶわかる！ 最新ロードバイクメンテナンス超入門', 'ゲットナビ編集部', '学研プラス', '2017-04-04', 'https://play.google.com/store/books/details?id=nGKYDgAAQBAJ&source=gbs_api', 'たくさんの写真でわかりやすく説明する、ロードバイクメンテナンスの決定版。注油やブレーキ調整、クランク・ＢＢの交換まで、これ一冊ですべて解決！ パーツ名／症状のダブル検索ができるので、知りたいことがすぐにわかる。全頁オールカラー。', '4059161632', '2018-10-18 23:23:26', 'http://books.google.com/books/content?id=nGKYDgAAQBAJ&printsec=frontcover&img=1&zoom=5&edge=curl&source=gbs_api');
