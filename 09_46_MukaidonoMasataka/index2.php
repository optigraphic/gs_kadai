...
$wname = $_POST["wname"];
$wwriter = $_POST["wwriter"];
$wpublisher = $_POST["wpublisher"];
$wpublishedDate = $_POST["wpublishedDate"];
$wcomme = $_POST["wcomme"];
$wurl = $_POST["wurl"];
$wisbn = $_POST["wisbn"];
...
<form method="POST" action="insert.php">
  <div class="jumbotron">
   <fieldset>
    ...
    <table>
     <tr><td>書籍名</td><td><input type="text" name="name" size="41" id="name" value="<?=$wname?>"></td></tr>
     <tr><td>著者</td><td><input type="text" name="writer" size="41" id="writer" value="<?=$wwriter?>"></td></tr>
     <tr><td>出版社</td><td><input type="text" name="publisher" size="41" id="publisher" value="<?=$wpublisher?>"></td></tr>
     <tr><td>出版日</td><td><input type="text" name="publishedDate" size="41" id="publishedDate" value="<?=$wpublishedDate?>"></td></tr>
     <tr><td>URL</td><td><input type="text" name="url" size="41" placeholder="http://" id="url" value="<?=$wurl?>"></td></tr>
     <tr><td>概要</td><td><textArea name="comme" rows="4" cols="40" id="comme" ><?=$wcomme?></textArea></td></tr>
     <tr><td>ISBN</td><td><input type="text" name="isbn" size="41" id="isbn" value="<?=$wisbn?>" placeholder="ハイフン(-)は入れずに入力で自動入力" ></td><td><div id="isbngo">ISBN検索</div></td></tr>
